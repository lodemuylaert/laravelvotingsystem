...
(function ($) {
    ...
    var PrintArea = {
        ...
        write: function write(PADocument, $ele) {
            PADocument.open();
            PADocument.write(PrintArea.docType() + "<html>" + PrintArea.getBody($ele) + "</html>");
            PADocument.close();
        },
    ...
    //printing confirm page of new voter
    $("#PrintVoter").click(function () {
        var mode = 'iframe'; //popup
        var close = mode == "popup";
        var options = { mode: mode, popClose: close };
        $("div.contenttoprint").printArea(options);
    });
})(jQuery);
